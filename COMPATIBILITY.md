...
| Vite                | Verified     | Real build failure reduction and recipient verification in the compatibility corpus |
| Jest                | Verified     | Real assertion failure and test-structure reduction in the compatibility corpus     |
